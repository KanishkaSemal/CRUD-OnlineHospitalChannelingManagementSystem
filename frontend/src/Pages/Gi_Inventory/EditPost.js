                    ...
                    <div className='body-wrapper'>
                        ...
                        <div className='col-md-8 mt-4 mx-auto'>
                            <div className='my-div'>
                                <h1 className='h3 mb-3 font-weight-normal'style={{ marginTop:40,textAlign:'center' }}>Update Product Details  <a className="btn btn-danger" href="/product" style={{marginLeft:900}} >
                                        &nbsp;Back
                                    </a>
                                </h1>
